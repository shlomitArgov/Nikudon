...
**Wave 1**
  ...
  - [x] 01-01-PLAN.md — Tap-to-hear vertical slice (Walking Skeleton): Vite client types, placeholder clips, wav precache glob, audioAssets manifest, useAudioPlayer hook, wired into StagePlayer (removes alert stub)
